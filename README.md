...
### Note
This project was created in a repository separate from [`alx-low_level_programming`](https://github.com/allelomorph/alx-low_level_programming), where the other projects from this section are located.
...
### Note
While found in a separate repository, this project is part of [`alx-low_level_programming`](https://github.com/allelomorph/alx-low_level_programming).
...
## team
* **Thales Solomon** - [AworThales](github.com/AworThales)
